...
/* ── 스킨에 창구 하나 내기 ──────────────────────────────────────────────
   ...
   그래서 모듈 맨 끝에 한 줄을 덧붙여 네 개만 꺼낸다:
     ...
     fS  스티커를 화면에 만들어 붙인다 (스킨이 만드니 끌기·색·효과 다 된다)
...
const HOOK = '\n;try{window.__ddsSlot={' +
  ...
  'addSticker:function(st){var L=document.getElementById("sticker-layer");' +
    'if(!L)return false;fS(L,[st],{keepExisting:true});return true}' +
  '};}catch(e){}\n';
